...
# the paragraphs into PROCEDURE and the flags into WORKING-STORAGE; the LLM
# is told to PERFORM the paragraphs and test the flags, not redeclare them.
...
def convert_all(
    ...
    if preamble and preamble.files:
        ...
        # Same contract as OPEN/CLOSE: Python owns them, the LLM PERFORMs the
        # paragraphs and tests the flags instead of writing its own READ.
